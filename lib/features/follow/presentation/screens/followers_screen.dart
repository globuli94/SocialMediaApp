...
//
// FollowersScreen — displays a list of users who follow the viewed user.
...
/// Screen that displays a list of users who follow the viewed user.
class FollowersScreen extends StatefulWidget {
  ...
  /// The UID of the user to load followers for.
  final String uid;
