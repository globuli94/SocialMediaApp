...
//
// FollowingScreen — displays a list of users that the viewed user follows.
...
/// Screen that displays a list of users that the viewed user follows.
class FollowingScreen extends StatefulWidget {
  ...
  /// The UID of the user to load following list for.
  final String uid;
