...
/// Screen that displays a list of users who follow a given user.
class FollowersScreen extends StatefulWidget {
  /// Creates a [FollowersScreen].
  ///
  /// [uid] is the UID of the user whose followers to display.
...
class _FollowersScreenState extends State<FollowersScreen> {
  ...
  void didChangeDependencies() {
    ...
    context
        .read<FollowListBloc>()
        .add(FollowListWatchFollowersStarted(widget.uid));
  }
            ...
            FollowListFailure(:final error) => Center(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text('Could not load followers'),
